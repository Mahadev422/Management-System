...
const Home = () => {
  const features = [
    {
      ...
      description: "Access curated study materials, e-books, and research papers",
      color: "bg-blue-100 text-blue-600"
    },
    {
      icon: <FaCalendarAlt className="w-8 h-8" />,
      title: "Campus Events",
      description: "Stay updated with workshops, seminars, and social gatherings",
  ...
  const stats = [
    { number: "10K+", label: "Active Students", icon: <FaUsers className="w-6 h-6" /> },
    { number: "500+", label: "Study Resources", icon: <FaBookOpen className="w-6 h-6" /> },
    { number: "100+", label: "Clubs & Societies", icon: <FaRegHandshake className="w-6 h-6" /> },
    { number: "50+", label: "Monthly Events", icon: <FaCalendarAlt className="w-6 h-6" /> }
  ];
  ...
  const testimonials = [
    {
      ...
      content: "UniConnect helped me find study groups and resources that improved my grades significantly!",
      icon: <FaStar className="w-5 h-5 text-yellow-500" />
    },
    {
      name: "Michael Chen",
      role: "Club President",
      content: "Managing events and recruiting members has never been easier with this platform.",
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
          <div className="lg:w-1/2">
            ...
            <p className="text-xl text-gray-600 mb-8">
              Connect with peers, access resources, join clubs, and never miss an event. 
              Everything you need for a successful campus life in one place.
            </p>
          ...
          {[
            {
              ...
              description: "AI-powered recommendations for study materials tailored to your courses",
              icon: <HiAcademicCap className="w-10 h-10" />,
              color: "text-blue-600"
            },
            {
              title: "Event Management",
              description: "Create, manage, and promote events with built-in registration system",
              icon: <FaRocket className="w-10 h-10" />,
              color: "text-green-600"
            },
            {
              title: "Club Hub",
              description: "Discover and join student organizations with detailed information",
            ...
            {
              title: "Discussion Forums",
              description: "Engage in academic discussions and get help from peers",
            ...
            <div key={index} className="bg-white p-6 rounded-2xl shadow-lg hover:shadow-xl transition-shadow duration-300 border border-gray-100">
              <div className={`p-3 rounded-xl bg-gray-50 w-fit mb-4 ${feature.color}`}>
                {feature.icon}
              </div>
